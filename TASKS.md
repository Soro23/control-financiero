...
**3. La categoría muestra una clave string en lugar del nombre** ✅ (ya estaba implementado correctamente)
- En el formulario de añadir/editar movimiento, al seleccionar una categoría del dropdown
- En lugar de mostrar el nombre legible (ej: "Alimentación"), muestra una clave técnica (ej: "food" o "category_001")
